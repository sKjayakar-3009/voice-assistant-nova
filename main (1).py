...
def open_translation_window(update_ui_callback):
    ...
    mic_image = Image.open("photos/mic.png")
...
class VoiceAssistantApp:
    def __init__(self, root):
        ...
        self.video_path = "photos/back.mp4"
    ...
    def create_profile_card(self):
        ...
        try:
            img = Image.open("photos/user.png")
    ...
    def setup_gui(self):
        self.ellie_image_path = "photos/nova.jfif"
        self.user_image_path = "photos/user.png"
